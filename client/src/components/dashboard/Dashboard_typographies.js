...
class Dashboard_typographies extends Component {
  constructor(props) {
    super();
    this.state = {
            ...
            <div className="mobile-only container">
                ...
                <div className="row" style={{marginTop:30}}>
                    ...
                    <Step.Group size='mini' widths={7}>
                            ...
                            <Step href='/dashboard_typographies' active>
                            <img src={process.env.PUBLIC_URL + '/typographies.png'} className='image_icon_steps' alt='typography'/>
                            <Step.Content>
                                <Step.Title><b style={{color:'black'}}>Typographies</b></Step.Title>
                            </Step.Content>
                    ...
                    : <Step.Group size="small">
                            <Step href='/dashboard_typographies' active>
                            <img src={process.env.PUBLIC_URL + '/dashboard_typographies.png'} className='image_icon_steps' alt='typography'/>
                            <Step.Content>
                                <Step.Title><b style={{color:'black'}}>Typographies</b></Step.Title>
                            </Step.Content>
                            </Step>
...
export default Dashboard_typographies;
