...
class Landing extends Component {
  ...
  handleSubmission = () => {
    ...
    if (this.state.url.substring(0,4) !== 'http'){
    ...
    } else if (!this.state.invitation_code) {
      ...
      {/* 分析店铺 */} 
      axios
      .post("/api/scrape/scrape_png", {url: this.state.url, process: 1}, {timeout: 30000})
      .then(res => {
        //console.log('res.data ', res.data)
        console.log('scrape_png process 1 res.data(1,14) is ', res.data[0].substring(1,14))
        this.setState({progress: 10})
        console.log('this.state.progress: ', this.state.progress)

        setTimeout(function(){ 
          console.log('timer 1: check_process1')
          console.log('res.data: ', res.data)
          axios
          .post("/api/scrape/check_process1", {url: res.data[0]})
          .then(res=>{
            if (!res.data){
              setTimeout(function(){
                console.log('timer 2: check_process1')
                axios
                .post("/api/scrape/check_process1", {url: this.state.url})
                .then(res=>{
                  if (!res.data){
                    setTimeout(function(){
                      console.log('timer 3: check_process1')
                      axios
                      .post("/api/scrape/check_process1", {url: this.state.url})
                      .then(res=>{
                        if (!res.data){
                          console.log('time out three times')
        ...
        const afterprocess = () => {
          console.log('in afterprocess')
          axios
          .post("/api/scrape/scrape_png_process2", {url: this.state.url}, {timeout: 30000})
          .then(res => {
            console.log('scrape_png process 2 res.data(1,14) is ', res.data[0])
              ...
              if (res.data[0].substring(1,14) === 'cannot scrape'){
                ...
                axios
                  .post("/api/scrape/scrape_pdf", {url: this.state.url, process: 3}, {timeout: 30000})
                  .then(res => {
                    console.log('res.data in process 3: ', res.data)
                    if (res.data[0].substring(1,14) === 'cannot scrape'){
                      ...
                      console.log('this.state.progress: ', this.state.progress)
                        ...
                        axios
                        .post("/api/scrape/scrape_pdf", {url: this.state.url, process: 4}, {timeout: 30000})
                        .then(res => {
                          if (res.data[0].substring(1,14) === 'cannot scrape'){
                            console.log('cannot scrape')
                            this.setState({loading:false})
                            ...
                            console.log('res.data process 4: ', res.data)
                            console.log('res.data[1] process 4: ', res.data[1])
                            ...
                            console.log('this.state.progress: ', this.state.progress)
                              ...
                              axios
                              .post("/api/scrape/scrape_pdf", {url: this.state.url, process: 5, num: res.data[1]}, {timeout: 30000})
                              .then(res => {
                                ...
                                if (res.data[0].substring(1,14) === 'cannot scrape'){
                                  ...
                                  this.setState({window:true, progress: 5})
                                    ...
                                    axios
                                    .post("/api/scrape/scrape_pdf_p2", {url: this.state.url, process: 6, num: res.data[1]}, {timeout: 30000})
                                    .then(res => {
                                      ...
                                      if (res.data[0].substring(1,14) === 'cannot scrape'){
                                        ...
                                        this.setState({window:true, progress: 5})
                                          ...
                                          console.log('this.state.progress: ', this.state.progress)
                                            ...
                                            axios
                                              .post("/api/scrape/scrape_pdf_p2", {url: this.state.url, process: 7, num: res.data[1]}, {timeout: 30000})
                                              .then(res => {
                                                ...
                                                if (res.data[0].substring(1,14) === 'cannot scrape'){
                                                  ...
                                                  this.setState({window:true, progress: 5})
                                                    ...
                                                    axios
                                                    .post("/api/scrape/scrape_pdf_p2", {url: this.state.url, process: 8, text_list1: res.data[1], text_list2: res.data[2]}, {timeout: 30000})
                                                    .then(res => {
