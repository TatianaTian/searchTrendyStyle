...
class Comparison_texts_example extends Component {
  constructor(props) {
    super();
    this.state = {
    ...
    return (
        ...
        <div className="container">  
            ...
            {/*<Segment.Group>
                ...
                <Segment>
                    <h4 className='heading'>How to read "Texts"</h4>
                    <h5 style={{marginBottom:10}}>All texts & total count of words</h5>
                    We displayed all the texts extracted from your homepage and the word count. Customers usually spend less than 20 seconds on the page, so using headlines and subheadlines to deliver store/product information is essential. Do customers know what you are selling after reading the headlines and subheadlines?
                    <h5 style={{marginBottom:10}}>Keywords that customers could notice after glimpsing</h5>
                    We extracted keywords from your texts - these are also what most customers notice after glimpsing the front page. Ideally, the keywords can deliver the information about your core product and store information. Compare how your keywords are different from those of anthropologies.com and brainstorm how to refine the texts.
                    <h5 style={{marginBottom:10}}>Emotions that customers could read from the texts</h5>
                    We can detect the tone of your paragraphs. See what customers' emotions are triggered by your texts and how antrhopologies.com handles it differently. 
                    <h5 style={{marginBottom:10}}>Syntax</h5>
                    Should you mainly use nouns, verbs, or adjectives to describe the store and products? Syntax distribution is a good indicator of store writing styles of effectiveness. See how anthropologires.com and thecurated.net handle their texts in review 1 and review 2, find some trends, and improve on your texts!
                </Segment>
            </Segment.Group>*/}
            ...
            <Step.Group size='mini' widths={7}>
                ...
                <Step href='/texts_example' active>
...
export default Comparison_texts_example;
