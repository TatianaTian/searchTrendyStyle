                ...
                <div placeholder style={{backgroundColor:'#f0f7f2'}}>
                  <div style={{textAlign:"left", marginLeft: 20, marginTop: 50}}>
                    ...
                    <div className="col s6" style={{marginLeft:-10}}>
                      ...
                      <p style={{color:"#696969"}}>(all data below are for example - not real analysis)</p>
                      </div>
                    </span>
                    </div>
                  ...
                  <Grid columns={2} stackable>
                    <Grid.Row verticalAlign='top'>
                      ...
                      <br/><br/>
                        Much like visual merchandising’s many benefits for traditional physical stores, it’s even more critical for use in eCommerce stores since the visual is the only medium between you and your customers. The homepage is your showcase, the category and product pages are the shelves. Winning the battle of visual merchandising will directly lead to increased key online metrics such as engagement, time on site, conversion rate, and average order value (AOV) and we are here to help you get there. 
                        <br/><br/>
                        Below is a list of a few areas that we see opportunities of improvements for your store. Scroll down to read more details.
                      </p>
                      {
                        !this.state.user.paid?
                        <Button content='Standard' basic style={{textAlign:'center'}}>Example</Button>
                        :
                        <List celled>
                          {summary_list}
                      </List>
                    ...
                    <Grid.Column>
                            ...
                            :<>
                              ...
                              <Accordion.Content active={this.state.activeIndex === 0}>
                                  ...
                                  <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                                    We studied hundreds of high performing e-commerce sellers of all size and found out that a top e-commerce store's desktop view usually contains <b>3-10</b> pages. 
                                  </p>
                                  <Bar 
                                    data={barChartData2}
                                  ...
                                  />
                                  <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                                    We studied dozens of high performing e-commerce sellers of all size within {this.state.user.category} category, and found out that the desktop view of a top e-commerce store of this category usually contains <b>{AS[this.state.user.category].Page_length.Min}-{AS[this.state.user.category].Page_length.Max}</b> pages. 
                                  </p>
                                  <Bar 
                                      data={barChartData1}
                                      options={barChartOptions}
                              ...
                              <Accordion.Title
                                ...
                                >
                                  ...
                                  <Icon name='dropdown' /> homepage section
                              </Accordion.Title>
                      ...
                      <Grid.Column>
                        <div class="ui raised segment" style={{backgroundColor:'white', borderRadius:5, marginLeft:20, marginRight:20, marginTop: 0, marginBottom:20}}>
                            ...
                            <Accordion.Content active={this.state.activeIndex1 === 0}>
                              <div class="ui raised segment" style={{padding:20}}>
                                ...
                                <Bar 
                                    ...
                                    />
                                <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                                We studied dozens of high performing e-commerce sellers of all size in {this.state.user.category} category, and found out that e-commerce store's homepage of this category usually contains <b>{AS[this.state.user.category].Image_number.Min}-{AS[this.state.user.category].Image_number.Max}</b> pages. 
                                </p>
                                <Bar 
                                      data={barChartData4}
                                      options={barChartOptions3}
                                    ...
                                    <a>
                                      {
                                        ...
                                        : <p style={{textAlign:'left', fontWeight:'bold'}}>
                                            Improve following images that are rated as 'poor' for their aesthetic scores. If you are curious about how the aesthetic scoring system works, check <a href="/term" target="_blank" style={{color:'#1b1b1c'}}>here</a>. If you need help in specific strategies in improving your image aesthetics, contact us at <span style={{color:"#1b1b1c"}}>hello@haloy.co</span> and we will get in touch with you!
                                          </p>
                                      }
                                    ...
                                    <a>
                                      {
                                        ...
                                        :<p style={{textAlign:'left', fontWeight:'bold'}}>
                                            Improve following images that are rated as 'poor' for their technical scores. If you are curious about how the technical scoring system works, check <a href="/term" target="_blank" style={{color:'#1b1b1c'}}>here</a>. If you need help in specific strategies in improving your image techniques, contact us at <span style={{color:"#1b1b1c"}}>hello@haloy.co</span> and we will get in touch with you!
                                        </p>
                                      }
                                      </a>
                                  </p>
                            ...
                            <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                              We studied hundreds of high performing e-commerce sellers of all size and found out that a top e-commerce store's homepage images have at least "good" rating aesthetic scores and technical scores.
                            </p>
                              <Bar 
                                    data={barChartData5}
                              ...
                              <Bar 
                                  ...
                                  />
                            <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                              We studied dozens of high performing e-commerce sellers of all size in {this.state.user.category} category, and found out that e-commerce store's homepage of this category usually have at least "good" rating aesthetic scores and technical scores.
                            </p>
                              <Bar 
                                    data={barChartData6}
                                    options={barChartOptions5}
                            ...
                            <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                              Our intensive study of successful e-commerce store tells us that picture is usually effective when the customers could easily notice the product in the image. Most successful stores usually have more than 75% of the store images contain their real products.
                            </p>
                            <Bar 
                                data={barChartData9}
                              ...
                              <div class="ui raised segment" style={{padding:20}}>
                                <p style={{fontWeight:'bold'}}>Actionable strategies</p>
                                {
                                  ...
                                  : <>
                                    ...
                                    <p style={{fontWeight:'bold', textAlign:'left'}}>The brand identity you picked</p>
                                    <p style={{color:'#696969', textAlign:'left', marginTop:-10}}>{AS[category].Theme_color[`style_${this.state.user.labelResults.style.substring(1,2)}_name`]}</p>
                      ...
                      <img src={process.env.PUBLIC_URL + '/text.png'} className='image_icon_steps' alt='layout'/>
                            ...
                            <Accordion.Content active={this.state.activeIndex3 === 0}>
                                <p style={{color: '#696969', textAlign:'left'}}>When we read, we've all had experiences struggling with too much content and losing the thesis. Conversely, we also had experience with barely abstract images and a few words, grappling with confusions. Same extremes apply to your store homepage. The key to text count for your store homepage is finding a good balance in between.</p>
                            <div class="ui raised segment" style={{padding:20}}>
                                <p style={{fontWeight:'bold'}}>Actionable strategies</p>
                                {
                                  text_count<AS[category].Text_count.Min
                            ...
                            <Bar 
                              ...
                              />
                            <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                            We studied dozens of high performing e-commerce sellers of all size in {this.state.user.category} category, and found out that e-commerce store's homepage of this category usually contains <b>{AS[this.state.user.category].Text_count.Min}-{AS[this.state.user.category].Text_count.Max}</b> words
                            </p>
                            <Bar 
                                data={barChartData11}
                                options={barChartOptions10}
                      ...
                      <div class="ui raised segment" style={{backgroundColor:'white', borderRadius:5, marginLeft:20, marginRight:20, marginTop: 20, marginBottom:20}}>
                          ...
                          <br/>
                            ...
                            : <>
                              ...
                              <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                              We studied dozens of high performing e-commerce sellers of all size in {this.state.user.category} category, and found out that e-commerce store's homepage of this category usually contains <b>{AS[this.state.user.category].Font_count.Min}-{AS[this.state.user.category].Font_count.Max}</b> fonts.
                              </p>
                      ...
                      <Grid.Column>
                        <div class="ui raised segment" style={{backgroundColor:'white', borderRadius:5, marginLeft:20, marginRight:20, marginTop: 20, marginBottom:20}}>
                          <br/>
                            ...
                            <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                            We studied hundreds of high performing e-commerce sellers of all size and found out that a top e-commerce store's website first impression page has at least "good" aesthetic rating.
                            </p>
                              <Bar 
                                    data={barChartData15}
                            ...
                            <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                            We studied dozens of high performing E-commerce sellers of all size in {this.state.user.category} category, and found out that e-commerce store's website first impression page has at least "good" aesthetic rating. 
                            </p>
                              <Bar 
                                    data={barChartData16}
                                    options={barChartOptions14}
                          ...
                          />
                            <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                            We studied dozens of high performing e-commerce sellers of all size in {this.state.user.category} category, and found out that <b>{AS[this.state.user.category].Image_effectiveness_first.Ratio}%</b> of e-commerce store's website first impression page of this category display their products.
                            </p>
                            <Doughnut
                              height="150vh"
                          ...
                          />
                            ...
                            <div class="ui raised segment" style={{padding:20}}>
                              ...
                              <Bar 
                                ...
                                />
                              <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                              We studied dozens of high performing e-commerce sellers of all size in {this.state.user.category} category, and found out that e-commerce store's website first impression page of this category usually contains <b>{AS[this.state.user.category].Text_count_first.Min}-{AS[this.state.user.category].Text_count_first.Max}</b> words
                              </p>
                              <Bar 
                                  data={barChartData14}
                                  options={barChartOptions13}
                ...
                <div placeholder style={{backgroundColor:'#f0f7f2'}}>
                  <div style={{textAlign:"left", marginLeft: 20, marginTop: 20}}>
                    ...
                    <div className="col s12" style={{marginLeft:-10}}>
                      <h2 className='heading'>Storefront Actionable Strategies</h2>
                      </div>
                      </span>
                    </div>
                          ...
                          <br/>
                            ...
                            :<>
                              ...
                              <div class="ui raised segment" style={{padding:20}}>
                                  ...
                                  <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                                    We studied hundreds of high performing e-commerce sellers of all size and found out that a top e-commerce store's desktop view usually contains 3-10 pages. 
                                  </p>
                                  <Bar 
                                    data={barChartData2}
                                    options={barChartOptions}
                                  />
                                  <p style={{color: '#696969', width:'90%', marginLeft:'5%', textAlign:'left'}}>
                                    We studied dozens of high performing e-commerce sellers of all size within {this.state.user.category} category, and found out that the desktop view of a top e-commerce store of this category usually contains 5-8 pages. 
                                  </p>
                                  <Bar 
                                      data={barChartData1}
                                      options={barChartOptions}
